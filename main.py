...
scope = 'playlist-modify-public user-library-read playlist-read-private user-read-private user-read-email user-top-read'
...
def make_reco_playlist():
    ...
    dance = request.form.get('dancibility')
